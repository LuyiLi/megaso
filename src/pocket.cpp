...
void pocket::composingTableUpdate()
{
	...
	else if (sortedData[1][0] && sortedData[1][1] && sortedData[1][2])
	{
		...
		//一个蓝棍一个银矿一个银宝石合成一个银剑
		if (sortedData[0][0] == 9 && sortedData[0][1] == 203 && sortedData[0][2] == 210)
		{
			craftData[0][0] = 404;
		}
		//一个金棍一个红矿一个红宝石合成一个红剑
		if (sortedData[0][0] == 8 && sortedData[0][1] == 202 && sortedData[0][2] == 209)
		{
			craftData[0][0] = 403;
		}
		//一个金棍一个金矿一个金宝石合成一个金剑
		if (sortedData[0][0] == 10 && sortedData[0][1] == 205 && sortedData[0][2] == 209)
		{
			craftData[0][0] = 402;
		}
		//一个火龙果一个银剑一个金剑合成一个宝剑
		if (sortedData[0][0] == 212 && sortedData[0][1] == 402 && sortedData[0][2] == 404)
		{
			craftData[0][0] = 401;
		}
		//一个穿山甲鳞片一个银镐一个金镐合成一个神镐
		if (sortedData[0][0] == 206 && sortedData[0][1] == 302 && sortedData[0][2] == 304)
		{
			craftData[0][0] = 301;
		}
		//两个金树一个金宝石合成一个金镐
		if (sortedData[0][0] == 205 && sortedData[0][1] == 209 && sortedData[0][2] == 209)
		{
			craftData[0][0] = 302;
		}
		//两个蓝棍一个银宝石合成一个银镐
